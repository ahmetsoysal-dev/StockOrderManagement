...
{
    public partial class FrmProductRUD : Form
    {
        public FrmProductRUD()
        {
            InitializeComponent();
        }
        ...
        private void FrmProductRUD_Load(object sender, EventArgs e)
        {
            Fill_Listview("load");
            Fill_Sort_Combobox();
        ...
        void Fill_Listview(string Text)
        {
            ...
            {
                //formun load ı
                productList = productRepository.Select();
            }
            else if (Text == "TextChanged")
            {
                // arama - search
                productList = productRepository.Select(txt_Search.Text);
            }
            else
            {
                // sıralama combobox ı
                productList = productRepository.Sort(Text);
            }
        ...
        private void btn_Update_Click(object sender, EventArgs e)
        {
            ...
            {
                productRepository.ProductID = ListviewID;
                productRepository.ProductName = txt_ProductName.Text;
                productRepository.UnitsInStock = Convert.ToInt32(txt_UnitsInStok.Text);
                ...
                bool result = productRepository.Update();
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                bool result = productRepository.Delete();
